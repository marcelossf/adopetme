...
function Login() {
  ...
  const instruction = [{img:form1, Text: "Crie a sua conta." },
        ...
        {img:calendar1, Text: "A ONG responsável tem até três dias úteis para retornar a sua solicitação." },
        {img:seeYouSoon, Text: "Caso aprovado, é só combinar o formato de entrega do seu novo amigo!" },
]
const instruction2 = [{img:form1, Text: "Crie a sua conta." },
  ...
  return (
    <DivsContainer>
      ...
      <DivRigth>
        ...
        {form ? <LoginForm setForm={setForm} form={form} /> : <CadastreForm setForm={setForm} form={form}/>}
      </DivRigth>
      ...
      <DivLeft>
        ...
        <div className="btns">
          <button type="button"  onClick={muda} className={disablebtn1 ?'btnslogin':'btnslogin disable' }>
            Adotante
          </button>

          <button type="button"  onClick={muda} className={disablebtn2 ?'btnslogin':'btnslogin disable' }>
            ONG
          </button>
        </div>
        {userOng ? (
           ...
           <div className="textimg">
            <div className="divimg">
              <img src={item.img} key={index} className="instructionimg" alt={item.Text} />
              </div>
            <span>{item.Text}</span>
           </div>)}
